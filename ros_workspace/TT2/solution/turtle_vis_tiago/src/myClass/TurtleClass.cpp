...
void TurtleClass::getPose(const turtle_vis_tiago::DesiredPose::ConstPtr &msg)
{
...
bool TurtleClass::getDPose(turtle_vis_tiago::send_desired_pose::Request &req, turtle_vis_tiago::send_desired_pose::Response &res)
{
    pthread_mutex_lock( &this->count_mutex );
